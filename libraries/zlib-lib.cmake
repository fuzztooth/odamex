...
if(BUILD_CLIENT OR BUILD_SERVER)
  if(USE_INTERNAL_ZLIB)
    ...
    if(CMAKE_MAKE_PROGRAM)
      list(APPEND _ZLIB_GEN_ARGS "-DCMAKE_MAKE_PROGRAM=${CMAKE_MAKE_PROGRAM}")
    endif()
    if(CMAKE_TOOLCHAIN_FILE)
      list(APPEND _ZLIB_GEN_ARGS "-DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}")
    endif()
    if(ANDROID)
      # Pass Android-specific variables to zlib build
      if(ANDROID_ABI)
        list(APPEND _ZLIB_GEN_ARGS "-DANDROID_ABI=${ANDROID_ABI}")
      endif()
      if(ANDROID_PLATFORM)
        list(APPEND _ZLIB_GEN_ARGS "-DANDROID_PLATFORM=${ANDROID_PLATFORM}")
      endif()
      if(ANDROID_NDK)
        list(APPEND _ZLIB_GEN_ARGS "-DANDROID_NDK=${ANDROID_NDK}")
      endif()
    endif()
    ...
    if(CMAKE_OSX_ARCHITECTURES)
      ...
      list(APPEND _ZLIB_GEN_ARGS "-DCMAKE_OSX_ARCHITECTURES=${_OSX_ARCHS}")
    endif()
